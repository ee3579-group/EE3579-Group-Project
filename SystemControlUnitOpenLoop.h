...
// class of open loop control

class SpeedControlOpenLoop{
	protected:
	...
	public:
		...
		//two speed-adjustments; two target-speed checks; two button checks; 
	...
	// these functions signal that it's time perform an aciton 
	...
	{
		int PWM = target_RPM; // no need for measured or curr as it is open loop and has no feedback
